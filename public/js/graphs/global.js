...
// Graph 1 //
const canvas1 = document.getElementById("chartGlobal1")
let data1 = [
  foundInternship.yes,
  foundInternship.no
]
const chart1 = {
  ...
  options: {
    title: {
      display: true,
      text: "Etudiants ayant trouvé un stage"
    },
    legend: {
      display: false
    }
...
// Graph 2 //
const canvas2 = document.getElementById("chartGlobal2");
  //format data
